                                                        ...
                                                        <td>
                                                            <div id="rtsocial-display-icon-sample">
                                                                <div class="rtsocial-fb-icon">
                                                                    <div class="rtsocial-fb-icon-button"><a class="rtsocial-fb-icon-link" href="http://www.facebook.com/sharer.php?u=http://rtpanel.com/support/forum/plugin/" target="_blank">Like</a></div>
                                                                </div>
                                                                
                                                                <div class="rtsocial-twitter-icon">
                                                                    <div class="rtsocial-twitter-icon-button"><a class="rtsocial-twitter-icon-link" href= "http://twitter.com/share?via=<?php echo $options['tw_handle'] . "&related=" . $options['tw_related_handle'] . "&text=" . esc_attr( "rtSocial... Share Fast!" ) . "&url=http://rtpanel.com/support/forum/plugin/"; ?>" target="_blank" >Tweet</a></div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div id="rtsocial-display-icon-count-sample">
                                                                <div class="rtsocial-fb-icon">
                                                                    <div class="rtsocial-fb-icon-button"><a class="rtsocial-fb-icon-link" href="http://www.facebook.com/sharer.php?u=http://rtpanel.com/support/forum/plugin/" target="_blank">Like</a></div><div class="rtsocial-horizontal-count"><div class="rtsocial-horizontal-notch"></div><span class="rtsocial-fb-count">0</span></div>
                                                                </div>
...
function rtsocial_counter( $content = '' ) {
    ...
    if(in_array('tw', $options['active'])){
        ...
        if ( $options['display_options_set'] == 'horizontal' ) {
            $tw_layout .= '<div class="rtsocial-twitter-' . $options['display_options_set'] . '-button"><a title= "' . esc_attr( get_the_title( $id ) ) . '" class="rtsocial-twitter-button" href= "http://twitter.com/share?text=' . rt_url_encode( get_the_title( $id ) ) . $handle_string.'" target=\"_blank\" ></a></div>'.$tw_count;
        } else if ( $options['display_options_set'] == 'vertical' ) {
            $tw_layout .= $tw_count.'<div class="rtsocial-twitter-' . $options['display_options_set'] . '-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-twitter-button" href= "http://twitter.com/share?text=' . rt_url_encode( get_the_title( $id ) ) . $handle_string.'" target= "_blank"></a></div>';
        } else if ( $options['display_options_set'] == 'icon' ) {
            $tw_layout .= ' <div class="rtsocial-twitter-' . $options['display_options_set'] . '-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-twitter-icon-link" href= "http://twitter.com/share?text=' . rt_url_encode( get_the_title( $id ) ) . $handle_string.'" target= "_blank"></a></div>';
            ...
            $tw_layout .= ' <div class="rtsocial-twitter-icon-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-twitter-icon-link" href= "http://twitter.com/share?text=' . rt_url_encode( get_the_title( $id ) ) . $handle_string.'" target= "_blank"></a></div>'.$tw_count;
        }
        $tw_layout .= '</div>';
    ...
    if(in_array('fb', $options['active'])){
        ...
        if ( $options['display_options_set'] == 'horizontal' ) {
            $fb_layout .= '<div class="rtsocial-fb-' . $options['display_options_set'] . '-button"><a title="' . $rt_social_text . '" class="rtsocial-fb-button ' . $class . '" href="http://www.facebook.com/sharer.php?" target="_blank"></a></div>'.$fb_count;
        } else if ( $options['display_options_set'] == 'vertical' ) {
            $fb_layout .= $fb_count.'<div class="rtsocial-fb-' . $options['display_options_set'] . '-button"><a title="' . $rt_social_text . '" class="rtsocial-fb-button ' . $class . '" href="http://www.facebook.com/sharer.php?" target="_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon' ) {
            $fb_layout .= ' <div class="rtsocial-fb-' . $options['display_options_set'] . '-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-fb-icon-link" href="http://www.facebook.com/sharer.php?u='.(urlencode(get_permalink($post->ID))).'" target= "_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon-count' ) {
            ...
            $fb_layout .= ' <div class="rtsocial-fb-icon-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-fb-icon-link" href="http://www.facebook.com/sharer.php?u='.(urlencode(get_permalink($post->ID))).'" target= "_blank"></a></div>'.$fb_count;
        }
        $fb_layout .= '</div>';
    ...
    if(in_array('pin', $options['active'])){
        ...
        if($options['display_options_set'] == 'horizontal'){
            $pin_layout .= '<div class="rtsocial-pinterest-' . $options['display_options_set'] . '-button"><a class="rtsocial-pinterest-button" href= "http://pinterest.com/pin/create/button/?url=' . get_permalink($post->ID) . '&media='.$thumb_src.'&description='.$title.'" target="_blank" ></a></div>'.$pin_count;
        } else if( $options['display_options_set'] == 'vertical' ){
            $pin_layout .= $pin_count.'<div class="rtsocial-pinterest-' . $options['display_options_set'] . '-button"><a class="rtsocial-pinterest-button" href= "http://pinterest.com/pin/create/button/?url=' . get_permalink($post->ID) . '&media='.$thumb_src.'&description='.$title.'" target="_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon' ) {
            ...
            $pin_layout .= ' <div class="rtsocial-pinterest-icon-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-pinterest-icon-link" href= "http://pinterest.com/pin/create/button/?url=' . get_permalink($post->ID) . '&media='.$thumb_src.'&description='.$title.'" target= "_blank"></a></div>'.$pin_count;
        }
        $pin_layout .= '</div>';
    ...
    if(in_array('lin', $options['active'])){
        ...
        if($options['display_options_set'] == 'horizontal'){
            $lin_layout .= '<div class="rtsocial-linkedin-' . $options['display_options_set'] . '-button"><a class="rtsocial-linkedin-button" href= "http://www.linkedin.com/shareArticle?mini=true&url='.urlencode(get_permalink($post->ID)).'&title='.urlencode(get_the_title( $post->ID )).'&summary='.$summary.'" target="_blank" ></a></div>'.$lin_count;
        } else if( $options['display_options_set'] == 'vertical' ) {
            $lin_layout .= $lin_count.' <div class="rtsocial-linkedin-' . $options['display_options_set'] . '-button"><a class="rtsocial-linkedin-button" href= "http://www.linkedin.com/shareArticle?mini=true&url='.urlencode(get_permalink($post->ID)).'&title='.urlencode(get_the_title( $post->ID )).'&summary='.$summary.'" target="_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon' ) {
            $lin_layout .= ' <div class="rtsocial-linkedin-' . $options['display_options_set'] . '-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-linkedin-icon-link" href= "http://www.linkedin.com/shareArticle?mini=true&url='.urlencode(get_permalink($post->ID)).'&title='.urlencode(get_the_title( $post->ID )).'&summary='.$summary.'" target= "_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon-count' ) {
            ...
            $lin_layout .= ' <div class="rtsocial-linkedin-icon-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-linkedin-icon-link" href= "http://www.linkedin.com/shareArticle?mini=true&url='.urlencode(get_permalink($post->ID)).'&title='.urlencode(get_the_title( $post->ID )).'&summary='.$summary.'" target= "_blank"></a></div>'.$lin_count;
        }
        $lin_layout .= '</div>';
    ...
    if(in_array('gplus', $options['active'])){
        ...
        if($options['display_options_set'] == 'horizontal'){
            $gplus_layout .= '<div class="rtsocial-gplus-' . $options['display_options_set'] . '-button"><a class="rtsocial-gplus-button" href= "https://plus.google.com/share?url='.urlencode(get_permalink($post->ID)).'" target="_blank" ></a></div>'.$gplus_count;
        } else if( $options['display_options_set'] == 'vertical' ) {
            $gplus_layout .= $gplus_count.'<div class="rtsocial-gplus-' . $options['display_options_set'] . '-button"><a class="rtsocial-gplus-button" href= "https://plus.google.com/share?url='.urlencode(get_permalink($post->ID)).'" target="_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon' ) {
            $gplus_layout .= ' <div class="rtsocial-gplus-' . $options['display_options_set'] . '-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-gplus-icon-link" href= "https://plus.google.com/share?url='.urlencode(get_permalink($post->ID)).'" target= "_blank"></a></div>';
        } else if( $options['display_options_set'] == 'icon-count' ) {
            ...
            $gplus_layout .= ' <div class="rtsocial-gplus-icon-button"><a title="' . rt_url_encode( get_the_title( $id ) ) . '" class="rtsocial-gplus-icon-link" href= "https://plus.google.com/share?url='.urlencode(get_permalink($post->ID)).'" target= "_blank"></a></div>'.$gplus_count;
        }
        $gplus_layout .= '</div>';
